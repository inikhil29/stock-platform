...
class RawHistoricalDataInfo(MySQLBase):
    ...
    instrument_key: Mapped[str] = mapped_column(ForeignKey(
        "upstox_stock_instrument_data.instrument_key"), index=True, nullable=False)
    ...
    instrument: Mapped["UpstoxInstrumentData"] = relationship(
