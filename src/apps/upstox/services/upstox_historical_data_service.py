...
class UpstoxHistoricalDataService:
    def __init__(self, raw_historical_data_info_repository: UpstoxRawHistoricalDataInfoRepository, upstox_historical_data_client: UpstoxHistoricalDataClient, aws_client: AwsClient):
    ...
    def _fetch_historical_data(self, instrument_key, unit, interval_option, from_date, to_date):
        result = self._upstox_historical_data_client.get_historical_data(
            instrument_key,
            unit,
            interval_option,
            to_date,
